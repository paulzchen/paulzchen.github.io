...
My thesis research investigated the atomistic processes underlying nanoparticle formation and harnessed these insights to expand the capabilities for nanoparticle design. We formulated [theoretical equations and the accompanying experimental methodology to characterize the supersaturation dynamics of nanoparticle growth](https://pubs.rsc.org/en/content/articlelanding/2022/nh/d1nh00572c). This approach enables for us to predict nanoparticle growth profiles and identify supersaturation-associated shape evolutions, providing insight for rational design at the nanoscale. We are completing additional studies to better understand nanoparticle growth and expand the range of achievable nanomaterials. 

We also discovered a [distinctive fundamental mode of growth using colloidal nanorods as a model system](https://pubs.acs.org/doi/10.1021/jacs.2c07423), expanding our understanding of how atoms move to form nanoparticles. Monomers generally deposit on a facet and then integrate into that same facet; that is, interfacet diffusion influences growth minimally, such that monomer deposition and integration are conflated as processes. Surprisingly, our experiments directly visualized adatoms diffusing readily and asymmetrically between the facets of Au nanorods. We developed equations and theoretical models, which supported that asymmetric interfacet adatom diffusion can mediate a distinctive mode of growth, for which monomer deposition and integration occur separately on different facets. Through an industrial collaboration, we have also applied our nanomaterials to develop biomedical technologies. More to come!
...
1. **Chen, P.Z.**, Skirzynska, A., Yuan, T., Voznyy, O., Gu, F.X.* [Asymmetric interfacet adatom migration as a mode of anisotropic nanocrystal growth.](https://pubs.acs.org/doi/10.1021/jacs.2c07423) _J. Am. Chem. Soc._, published online (2022).
...
- [Asymmetric interfacet adatom migration as a mode of anisotropic nanocrystal growth](https://twitter.com/paulchenz/status/1580712149428875264?s=20&t=QRTD30kPOF3A8kkcJ84JTA)
