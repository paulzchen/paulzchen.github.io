...
## My Research
In early March 2020, I pivoted my research to help with the response against COVID-19. My work helped to understand why superspreading drives the COVID-19 pandemic, assess the extent to which SARS-CoV-2 is shed via droplets and aerosols, characterize the respiratory kinetics of SARS-CoV-2, find an indicator to potentially predict severe COVID-19 before clinical deterioration, and develop methods to decontaminate N95 respirators for reuse. Our findings supported the airborne transmission of SARS-CoV-2, aiding its public acceptance. We also published the first study to identify a virological factor that facilitates overdispersion, and superspreading, for directly transmitted viruses. 
