...
We also discovered a [distinctive growth mode on colloidal nanoparticles](https://pubs.acs.org/doi/10.1021/jacs.2c07423). Monomers generally deposit on a facet and then integrate into that same facet, i.e., interfacet diffusion influences growth minimally, such that monomer deposition and integration are conflated as processes. Surprisingly, our experiments on a model of Au nanorods directly visualized adatoms diffusing readily and asymmetrically between facets. We developed equations and theoretical models, which supported that asymmetric interfacet adatom diffusion can mediate a distinctive fundamental mode of growth, for which monomer deposition and integration occur separately on different facets. Through an industrial collaboration, we have also applied our nanomaterials to develop biomedical technologies. More to come!
