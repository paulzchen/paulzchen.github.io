...
## My Research
In early March 2020, I pivoted my research to help respond against COVID-19, towards understanding why superspreading drives the COVID-19 pandemic, assessing how SARS-CoV-2 is shed via droplets and aerosols, characterizing the respiratory kinetics of SARS-CoV-2, finding an indicator to potentially predict severe COVID-19 before clinical deterioration, and developing methods to decontaminate N95 respirators for reuse. Our work supported that SARS-CoV-2 is transmitted via aerosols, aiding the public acceptance of airborne transmission. We also published the first study to identify a virological factor that facilitates overdispersion, and superspreading, for directly transmitted viruses. 

Outside of COVID-19, I investigate how nanocrystals form at the atomic level and use that insight to engineer nanomaterials for health applications. I am passionate about developing new methodological approaches to design materials and technologies that address key health, energy and environmental issues. Overall, I hope our work helps improve both science and society.
